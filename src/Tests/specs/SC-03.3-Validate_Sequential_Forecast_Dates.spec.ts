...
When("the API returns the sequential forecast response", async function (this: CucumberWorld) {
  await steps.THE_API_RETURNS_THE_SEQUENTIAL_FORECAST_RESPONSE(this);
});

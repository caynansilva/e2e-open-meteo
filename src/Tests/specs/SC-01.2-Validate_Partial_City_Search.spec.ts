...
When("the API returns the matching partial city response", async function (this: CucumberWorld) {
  await steps.THE_API_RETURNS_THE_MATCHING_PARTIAL_CITY_RESPONSE(this);
});

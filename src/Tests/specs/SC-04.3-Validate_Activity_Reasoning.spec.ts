...
When("the API returns the activity reasoning response", async function (this: CucumberWorld) {
  await steps.THE_API_RETURNS_THE_ACTIVITY_REASONING_RESPONSE(this);
});

...
When(
    "the client sends a GET request to the activities endpoint without the city parameter",
    async function (this: CucumberWorld) {
        await steps.THE_CLIENT_SENDS_A_GET_REQUEST_TO_THE_ACTIVITIES_ENDPOINT_WITHOUT_THE_CITY_PARAMETER(this);
    }
);
